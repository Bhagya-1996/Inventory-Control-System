...
<hr width="849" align="left" />
	<table border="0" cellpadding="5">
    	<tr><td><h4><strong><a href="monSalRepot.php"><b>Monthly Sales Report</b></a></strong></h4></td>
    	<td><h4><strong><a href="monPurRepot.php">Monthly Purchase Report</a></strong></h4></td></tr>
    </table>
	<br />
    <span class="auto-style3"><strong>Monthly Sales Report</strong></span>
   		<form action="monSalRepot.php" method="post" onSubmit="return checkdate();" name="report">
    ...
    <table border="1" width="849" class="gridtable">
    	<tr><th>No.</th><th>Invoice No</th><th>Date</th><th>Amount</th></tr>
   <?php
	...
	$nettotal=0;
		$result = mysqli_query($con, $sql);
			...
			{
				echo "<tr><td>$no</td><td>INVO".$row['invono']."</td><td>".$row['date']."</td><td align='right' class='currency'>".$row['total']."</td></tr>";
				$no++;
				$nettotal= $nettotal+$row['total'];
			}
			echo "<tr><td>Net Total</td><td></td><td></td><td class='currency'>".$nettotal."</td></tr>";
	?>
    </table>
    <br /><form action="printmonSalRepot.php" method="post"><input type="hidden" name="stDate" id="stDate" value="<?php if(!empty($startDate)){ echo $startDate;}?>" />
